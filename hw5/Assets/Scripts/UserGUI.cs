	...
	void OnGUI () {
        ...
        if (game_start) {
            ...
            if (action.GetRound() == 3 && action.GetTrial() == 10) {
                GUI.Label(new Rect(Screen.width / 2 - 20, Screen.height / 2 - 100, 100, 100), "游戏结束", over_style);
                GUI.Label(new Rect(Screen.width / 2 - 10, Screen.height / 2 - 50, 50, 50), "你的分数:" + action.GetScore().ToString(), text_style);
            ...
            GUI.Label(new Rect(Screen.width / 2 - 50,  Screen.height / 2 - 50, 100, 100), "鼠标点击飞碟", text_style);
